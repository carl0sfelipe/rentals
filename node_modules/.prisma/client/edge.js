...
const config = {
  ...
  "inlineSchema": "// Prisma schema for Rentals API\n// Basic User model (extend later)\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\nmodel User {\n  id        String   @id @default(cuid())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "43f111a2a9f9adcd27c85771a407928828459cd7b2660a1c352847a14feb5047",
  "copyEngine": true
}
config.dirname = '/'
